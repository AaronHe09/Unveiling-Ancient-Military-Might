import crossSword from '../../images/cross-sword.gif';
    ...
    <section id="intro-page-container">
      ...
      <div className="p-container">
        <p>
          ...
          history, and ensuring survival. From the Roman Empire's legions to the
          Greek phalanxes, military might was the driving force behind their
          greatness and eventual decline. These ancient militaries stories
          reflect the lasting impact of their strategies on history.
        </p>
        <p className="disclaimer">
          <i>
            ...
            you're a history genius or just a self-proclaimed history geek who's
            losing sleep over an inaccuracy you stumbled upon here, fear not!
            Just reach out to me, and I'll work my magic to rectify the
